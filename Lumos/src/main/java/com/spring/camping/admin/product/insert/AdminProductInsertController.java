...
import com.spring.camping.fileupload.AdminProductFileUploadCommand;
...
//		// 상품 등록 폼 
		...
		public String RegisterProduct(HttpServletRequest request, Model model, HttpSession session) throws ServletException, IOException { {
			...
			command = new AdminProductFileUploadCommand();
			...
			AdminProductInsert_IDao dao = sqlSession.getMapper(AdminProductInsert_IDao.class);
